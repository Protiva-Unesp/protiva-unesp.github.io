                        ...
                        {data.allMarkdownRemark.nodes.map((node, index) => (
                            <div key={index} className="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8 flex">
                                <div className="flex flex-col flex-grow">
                                    <Link to={`/introducao-a-programacao/${node.frontmatter.slug}`} className="flex flex-col flex-grow">
                                        <div className="flex flex-col justify-between p-6 bg-yellow-500 border border-gray-400 text-white flex-grow">
                                            <div>
