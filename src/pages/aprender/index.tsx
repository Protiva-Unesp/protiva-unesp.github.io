                ...
                <div className="flex flex-wrap -mx-4">
                    <div className="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/3 flex flex-col">
                     ...
                     <div className="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/3 flex flex-col">
                        <div className="flex flex-grow">
                            ...
                            <div className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
                                <div>
                                    <Link to="/aprender/04-forca-bruta-recursao-backtracking"
                                        className="block mb-4 text-2xl font-black leading-tight hover:underline hover:text-blue-600">
                                        04 - Força bruta, recursão e backtracking
                                    </Link>
                                    <p className="mb-4">
                    ...
                    <div className="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/3 flex flex-col">
                        <div className="flex flex-grow">
                            ...
                            <div className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
                                <div>
                                    <Link to="/aprender/05-algoritmo-guloso-divisao-conquista"
                                        className="block mb-4 text-2xl font-black leading-tight hover:underline hover:text-blue-600">
                                        05 - Algoritmo Guloso, Divisão e Conquista
                                    </Link>
                                    <p className="mb-4">
                     ...
                     <div className="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/3 flex flex-col">
                        <div className="flex flex-grow">
                            ...
                            <div className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
                                <div>
                                    <Link to="/aprender/06-programacao-dinamica"
                                        className="block mb-4 text-2xl font-black leading-tight hover:underline hover:text-blue-600">
                     ...
                     <div className="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/3 flex flex-col">
                        <div className="flex flex-grow">
                            ...
                            <div className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
                                <div>
                                    <Link to="/aprender/07-programacao-dinamica-2"
                                        className="block mb-4 text-2xl font-black leading-tight hover:underline hover:text-blue-600">
                                        07 - Programação Dinâmica 2
                                    </Link>
                                    <p className="mb-4">
                                        Técnica de otimização que resolve problemas dividindo-os em subproblemas sobrepostos, armazenando soluções intermediárias para evitar cálculos redundantes.
                                    </p>
                    ...
                    <div className="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/3 flex flex-col">
                        <div className="flex flex-grow">
                            ...
                            <div className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
                                <div>
                                    <Link to="/aprender/09-disjoint-set-union"
                                        className="block mb-4 text-2xl font-black leading-tight hover:underline hover:text-blue-600">
                                        09 - Disjoint-set (Union Find)
                                    </Link>
                                    <p className="mb-4">
                    ...
                    <div className="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/3 flex flex-col">
                        <div className="flex flex-grow">
                            ...
                            <div className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
                                <div>
                                    <Link to="/aprender/13-kmp-string-hashing"
                                        className="block mb-4 text-2xl font-black leading-tight hover:underline hover:text-blue-600">
                                        13 - KMP e String Hashing
                                    </Link>
                                    <p className="mb-4">
                     ...
                     <div className="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/3 flex flex-col">
                        <div className="flex flex-grow">
                            ...
                            <div className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
                                <div>
                                    <Link to="/aprender/14-teoria-dos-numeros"
                                        className="block mb-4 text-2xl font-black leading-tight hover:underline hover:text-blue-600">
                     ...
                     <div className="w-full max-w-full mb-8 sm:w-1/2 px-4 lg:w-1/3 flex flex-col">
                        <div className="flex flex-grow">
                            ...
                            <div className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 text">
                                <div>
                                    <Link to="/aprender/15-analise-combinatoria"
                                        className="block mb-4 text-2xl font-black leading-tight hover:underline hover:text-blue-600">
